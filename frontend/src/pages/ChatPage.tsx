...
const SUGGESTIONS: Array<{ tag: string; q: string }> = [
  ...
  { tag: 'Onboarding', q: 'What does the first week look like for a new engineer?' },
    ...
    <div className="flex flex-col items-start gap-7 pt-14 pb-10 animate-[riseIn_0.6s_var(--ease-out)]">
      ...
      >
        ...
        >
          ...
          <path strokeLinecap="round" strokeLinejoin="round" d="M20 28h24M20 36h24M20 44h16" />
      ...
      >
        Ask in plain language. Answers come from your team's own documents — every
        sentence traceable, every source one tap away.
      </p>
...
export function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto">
        <div className="w-full max-w-[740px] mx-auto px-5 sm:px-8 pt-6">
          ...
          {streaming && !messages.some(m => m.role === 'assistant' && m.content === '') && (
            <p className="text-fg-dim text-xs font-sans animate-pulse mt-3">Thinking…</p>
          )}
          <div ref={bottomRef} />
        </div>
      </div>
      ...
      <div
        className="px-5 sm:px-8 pt-4 pb-5 pb-safe"
        style={{
          background:
